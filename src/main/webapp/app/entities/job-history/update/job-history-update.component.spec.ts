...
describe('JobHistory Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call job query and add missing value', () => {
      ...
      const job: IJob = { id: 41903 };
      jobHistory.job = job;

      const jobCollection: IJob[] = [{ id: 97235 }];
    ...
    it('Should call department query and add missing value', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const department: IDepartment = { id: 76889 };
      jobHistory.department = department;

      const departmentCollection: IDepartment[] = [{ id: 61164 }];
    ...
    it('Should call employee query and add missing value', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const employee: IEmployee = { id: 50141 };
      jobHistory.employee = employee;

      const employeeCollection: IEmployee[] = [{ id: 60646 }];
    ...
    it('Should update editForm', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const job: IJob = { id: 88590 };
      jobHistory.job = job;
      const department: IDepartment = { id: 20905 };
      jobHistory.department = department;
      const employee: IEmployee = { id: 13206 };
      jobHistory.employee = employee;
