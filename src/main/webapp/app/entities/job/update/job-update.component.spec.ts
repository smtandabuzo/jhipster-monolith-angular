...
describe('Job Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Task query and add missing value', () => {
      ...
      const tasks: ITask[] = [{ id: 30819 }];
      job.tasks = tasks;

      const taskCollection: ITask[] = [{ id: 79281 }];
    ...
    it('Should call Employee query and add missing value', () => {
      const job: IJob = { id: 456 };
      const employee: IEmployee = { id: 2427 };
      job.employee = employee;

      const employeeCollection: IEmployee[] = [{ id: 36696 }];
    ...
    it('Should update editForm', () => {
      const job: IJob = { id: 456 };
      const task: ITask = { id: 12928 };
      job.tasks = [task];
      const employee: IEmployee = { id: 35921 };
      job.employee = employee;
